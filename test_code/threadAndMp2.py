...
# line 132 클래스 추가, line 195 함수 추가, line 220 함수 추가
# getVideoThread -> AddMediapipeThread -> showVideoThread 구조
# iteration 값 48000(데탑) 이상 찍히지만, 스켈레톤이 불안정함(흔들림, 옆으로 밀려 있음)