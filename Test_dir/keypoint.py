...
class KEYPOINT:
    ...
    def angle_of_the_left_arm(self): ## 푸쉬업 (왼쪽 어깨,팔꿈치,손목 각도)
        ...
        if l_shoulder[2] >= m.ref_visibility and l_elbow[2]  >= m.ref_visibility and l_wrist[2] >= m.ref_visibility:
    ...
    def angle_of_the_right_arm(self): ## 푸쉬업 (오른쪽 어깨,팔꿈치,손목 각도)
        ...
        if r_shoulder[2] >= m.ref_visibility and r_elbow[2]  >= m.ref_visibility and r_wrist[2] >= m.ref_visibility:
    ...
    def angle_of_the_left_spine(self):  ## 푸쉬업 (왼쪽 척추(어깨, 허리, 무릎) 각도)
        ...
        if l_shoulder[2] >= m.ref_visibility and l_hip[2] >= m.ref_visibility and l_knee >= m.ref_visibility:
    ...
    def angle_of_the_right_spine(self):  ## 푸쉬업 (오른쪽 척추(어깨, 허리, 무릎) 각도)
        ...
        if r_shoulder[2] >= m.ref_visibility and r_hip[2] >= m.ref_visibility and r_knee >= m.ref_visibility:
    ...
    def angle_of_the_left_leg(self): ## 스쿼트 (왼쪽 허리, 무릎, 발목 각도)
        ...
        if l_hip[2] >= m.ref_visibility and l_knee[2]  >= m.ref_visibility and l_ankle[2] >= m.ref_visibility:
    ...
    def angle_of_the_right_leg(self): ## 스쿼트 (오른쪽 허리, 무릎, 발목 각도)
        ...
        if r_hip[2] >= m.ref_visibility and r_knee[2]  >= m.ref_visibility and r_ankle[2] >= m.ref_visibility:
    ...
    def angle_of_the_left_knee(self): ## 스쿼트 (왼쪽 무릎, 발끝, 뒤꿈치 각도)
        ...
        if l_knee[2] >= m.ref_visibility and l_ankle[2]  >= m.ref_visibility and l_foot_index[2] >= m.ref_visibility:
    ...
    def angle_of_the_right_knee(self): ## 스쿼트 (오른쪽 무릎, 발끝, 뒤꿈치 각도)
        ...
        if r_knee[2] >= m.ref_visibility and r_ankle[2]  >= m.ref_visibility and r_foot_index[2] >= m.ref_visibility:
